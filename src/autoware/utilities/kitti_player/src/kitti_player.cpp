...
//    sensor_msgs::CameraInfo ros_cameraInfoMsg;
    ...
    if(options.viewer)
    {
        ...
        if(options.color || options.all_data)
        {
            ...
            cv_image02 = cv::imread(full_filename_image02, IMREAD_UNCHANGED);
            cv::waitKey(5);
        }
        if(options.grayscale || options.all_data)
        {
            ...
            cv_image00 = cv::imread(full_filename_image00, IMREAD_UNCHANGED);
            cv::waitKey(5);
        }
        if (options.viewDisparities || options.all_data)
        {
            ...
            cv_laneProjected = cv::imread(full_filename_laneProjected, IMREAD_UNCHANGED);
            cv::waitKey(5);
        }
    ...
    do
    {
        ...
        if(options.stereoDisp)
        {
            ...
            cv_image04 = cv::imread(full_filename_image04, IMREAD_GRAYSCALE);
...
*/
        if(options.color || options.all_data)
        {
            ...
            cv_image02 = cv::imread(full_filename_image02, IMREAD_UNCHANGED);
            cv_image03 = cv::imread(full_filename_image03, IMREAD_UNCHANGED);
        ...
        if(options.grayscale || options.all_data)
        {
            ...
            cv_image00 = cv::imread(full_filename_image00, IMREAD_UNCHANGED);
            cv_image01 = cv::imread(full_filename_image01, IMREAD_UNCHANGED);
