...
void TunerBody::saveResult(std::string fileName)
{
  ...
  /* write data to file */
  {
    ...
    cvfs << "RED" ;
    {
      ...
      cvfs << "center" <<  Red_set.hue.center;
      cvfs << "range" <<  Red_set.hue.range;
    }

    {
      ...
      cvfs << "Saturation";
      cvfs <<  "center" << Red_set.sat.center;
      cvfs << "range" <<  Red_set.sat.range;
    }

    {
      ...
      cvfs << "Value";
      cvfs << "center"<<  Red_set.val.center;
      cvfs << "range" <<  Red_set.val.range;
    }
  }

  {
    ...
    cvfs << "YELLOW";
    {
      ...
      cvfs << "center"<<  Yellow_set.hue.center;
      cvfs<< "range"<< Yellow_set.hue.range;
...

    {
      ...
      cvfs << "center"<< Yellow_set.sat.center;
      cvfs<<  "range"<<  Yellow_set.sat.range;
    }

    {
     ...
     cvfs << "Value";
      ...
      cvfs<< "center"<< Yellow_set.val.center;
      cvfs << "range"<< Yellow_set.val.range;
    }
  }

  {
    ...
    cvfs << "GREEN";
    {
      ...
      cvfs<< "center"<<Green_set.hue.center;
      cvfs<<"range"<< Green_set.hue.range;
    }

    {
      ...
      cvfs<< "center"<< Green_set.sat.center;
      cvfs<< "range"<< Green_set.sat.range;
    }

    {
      ...
      cvfs <<  "center"<< Green_set.val.center;
      cvfs << "range"<< Green_set.val.range;
    }
  }
...
void TunerBody::openSetting(std::string fileName)
{
  ...
  {
    cv::FileNode nd_red = cvfs[std::string("RED")];
    {
  ...
  {
    cv::FileNode nd_yellow = cvfs[std::string("YELLOW")];
    {
  ...
  {
    cv::FileNode nd_green = cvfs[std::string("GREEN")];
    {
